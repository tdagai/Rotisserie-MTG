...
const UnderConstructions = () => {
  return (
    <div id='under-constructions' >
      ...
      <p>
        Follow the project's <a href='https://github.com/tdagai/Rotisserie-MTG' target='_blank' className='link-style' >github</a> for updates on the current state of development!
      </p>
